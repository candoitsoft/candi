...
//			e.printStackTrace();
	...
	public void setMapping(String id){
		...
		String data = "{\"settings\": {\"number_of_shards\": 6,\"number_of_replicas\": 1},\"mappings\": {\"_default_\" : {\"properties\":{\"uci\":{\"type\":\"string\", \"index\" : \"not_analyzed\"},\"cid\":{\"type\":\"string\", \"index\" : \"not_analyzed\"},\"title\":{\"type\":\"string\", \"index\" : \"not_analyzed\"},\"album\":{\"type\":\"string\", \"index\" : \"not_analyzed\"},\"artist\":{\"type\":\"string\", \"index\" : \"not_analyzed\"},\"genre\":{\"type\":\"string\"},\"rdate\":{\"type\":\"string\"},\"ptime\":{\"type\":\"string\"},\"stime\":{\"type\":\"date\",\"format\":\"dateOptionalTime\"},\"svcode\":{\"type\":\"string\", \"index\" : \"not_analyzed\"},\"asp\":{\"type\":\"string\", \"index\" : \"not_analyzed\"},\"es_index\":{\"type\":\"string\", \"index\" : \"not_analyzed\"},\"es_type\":{\"type\":\"string\", \"index\" : \"not_analyzed\"},\"es_id\":{\"type\":\"string\", \"index\" : \"not_analyzed\"}}}}}";
		setEs(url, data);
	}
